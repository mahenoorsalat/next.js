  ...
  return (
    <main>
      ...
      <ul>
        ...
        <li>
          <LinkAccordion href="/divergent-cookies">
            Divergent cookies
          </LinkAccordion>
        </li>
        <li>
          <LinkAccordion href="/divergent-cookies-after-shell">
        ...
        <li>
          <LinkAccordion href="/speculative-divergent" prefetch={true}>
            Speculative divergent
          </LinkAccordion>
        </li>
        <li>
